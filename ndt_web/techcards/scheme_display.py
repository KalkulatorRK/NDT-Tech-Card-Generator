...
SCHEME_CHOICES = [
    ...
    ('5b',   'Чертёж 3б — Трубопровод Dн > 50 мм; плёнка внутри трубы (метод эллипса)'),
    ('5v',   'Чертёж 3в — Трубопровод Dн ≤ 100 мм; плёнка снаружи'),
...
SCHEME_USER_LABELS = {
    ...
    '5b':  'Чертёж 3б — трубопровод Dн > 50 мм (эллипс)',
...
SCHEME_DESCRIPTIONS = {
    ...
    '5b':  'Трубопровод Dн > 50 мм. Плёнка внутри трубы. Метод эллипса.',
    '5v':  'Трубопровод малого диаметра (Dн ≤ 100 мм). Плёнка снаружи.',
...
SCHEME_CARD_DESCRIPTIONS = {
    ...
    '5a':  'Трубопровод Dн > 50 мм. Плёнка внутри трубы.',
    '5b':  'Трубопровод Dн > 50 мм. Плёнка внутри трубы. Метод эллипса.',
    '5v':  'Трубопровод Dн ≤ 100 мм. Плёнка снаружи.',
    '5g':  'Трубопровод Dн > 50 мм. Плёнка снаружи.',
    '5d':  'Трубопровод Dн > 50 мм. Плёнка снаружи.',
